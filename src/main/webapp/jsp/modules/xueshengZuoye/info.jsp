            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">学生作业登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="zuoyeId" name="zuoyeId" v-model="ruleForm.zuoyeId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xueshengZuoyeTime" name="xueshengZuoyeTime" class="form-control"
                                               v-model="ruleForm.xueshengZuoyeTime" readonly>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="laoshiZuoyeTime" name="laoshiZuoyeTime" class="form-control"
                                               v-model="ruleForm.laoshiZuoyeTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="zuoyeNumber" name="zuoyeNumber" class="form-control"
                                               v-model="ruleForm.zuoyeNumber" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "xueshengZuoye/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.laoshiZuoyeContent != null && ruleForm.laoshiZuoyeContent != 'null' && ruleForm.laoshiZuoyeContent != '') {
            var laoshiZuoyeContentUeditor = UE.getEditor('laoshiZuoyeContentEditor');
                laoshiZuoyeContentUeditor.ready(function () {
                    ...
                    laoshiZuoyeContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var xueshengZuoyeFileUrl = "download('" + ruleForm.xueshengZuoyeFile + "')";
        $("#xueshengZuoyeFile").attr("onclick", xueshengZuoyeFileUrl);
        var laoshiZuoyeFileUrl = "download('" + ruleForm.laoshiZuoyeFile + "')";
        $("#laoshiZuoyeFile").attr("onclick", laoshiZuoyeFileUrl);
