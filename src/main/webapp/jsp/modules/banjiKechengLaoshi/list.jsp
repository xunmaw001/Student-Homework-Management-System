    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">班级课程老师关系管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">班级课程老师关系列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">班级课程老师关系列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                            ...
                                            <label>
                                                手机号
                                                <input type="text" id="laoshiPhoneSearch"  style="width: 120px;" class="form-control form-control-sm"
...
<script>
    ...
    function getDataList() {
        http("banjiKechengLaoshi/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("banjiKechengLaoshi/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addbanjiKechengLaoshi", "addbanjiKechengLaoshi");
        window.location.href = "add-or-update.jsp"
    }
