    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑班级课程老师关系</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">班级课程老师关系管理</li>
                        <li class="breadcrumb-item active">编辑班级课程老师关系</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">班级课程老师关系信息</h3>
...
<script>
    ...
    var tableName = "banjiKechengLaoshi";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#laoshiId") !=null){
            ...
            httpJson("banjiKechengLaoshi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addbanjiKechengLaoshi');
        ...
        function initializationbanjiSelect() {
            ...
            if(banjiSelect != null && banjiOptions != null  && banjiOptions.length > 0 ) {
                for (var i = 0; i < banjiOptions.length; i++) {
                        banjiSelect.add(new Option(banjiOptions[i].indexName, banjiOptions[i].id));
                }
        ...
        function initializationkechengSelect() {
            ...
            if(kechengSelect != null && kechengOptions != null  && kechengOptions.length > 0 ) {
                for (var i = 0; i < kechengOptions.length; i++) {
                        kechengSelect.add(new Option(kechengOptions[i].indexName, kechengOptions[i].id));
                }
    ...
    // 获取当前详情
    function getDetails() {
        var addbanjiKechengLaoshi = window.sessionStorage.getItem("addbanjiKechengLaoshi");
        if (addbanjiKechengLaoshi != null && addbanjiKechengLaoshi != "" && addbanjiKechengLaoshi != "null") {
            window.sessionStorage.removeItem('addbanjiKechengLaoshi');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("banjiKechengLaoshi/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    function banjiDataBind(){
        ...
        $("#banjiName").val(ruleForm.indexName);
    }
    ...
    function kechengDataBind(){
        ...
        $("#kechengName").val(ruleForm.indexName);
    }
    ...
    function laoshiDataBind(){
        ...
        $("#banjiName").val(ruleForm.username);
