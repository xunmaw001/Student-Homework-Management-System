                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            作业截止时间
                                            <input type="datetime-local" id="endTimeStartSearch" style="width: 190px;" class="form-control " placeholder="开始" aria-controls="tableId">
                                        </label>
                                            -
                                        <label>
                                            <input type="datetime-local" id="endTimeEndSearch" style="width: 190px;"  class="form-control" placeholder="结束" aria-controls="tableId">
                                        </label>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(checkbox)
                    ...
                    //班级
        var banjiIdCell = document.createElement('td');
        banjiIdCell.innerHTML = item.banjiName;
        row.appendChild(banjiIdCell);
        ...
        row.appendChild(kechengIdCell);
                    ...
                    //老师
        var laoshiIdCell = document.createElement('td');
        laoshiIdCell.innerHTML = item.laoshiName;
        row.appendChild(laoshiIdCell);
